...
import com.ingelecron.chatunab9.presentadores.IPreTab1Fragment;
import com.ingelecron.chatunab9.presentadores.PreTab1Fragment;
...
public class Tab1Fragment extends Fragment implements ITab1Fragment{
    ...
    @Override
    public AdaptadorRVContactos crearAdaptadorRVContactos(ArrayList<Contacto> contactoArrayList) {
        adaptadorRVContactos = new AdaptadorRVContactos(getActivity(), contactoArrayList);
    ...
    @Override
    public void generarLinearLayoutManger() {
