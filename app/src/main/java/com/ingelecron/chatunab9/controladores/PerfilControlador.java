...
public class PerfilControlador {
    ...
    public static void actualizarImagen(Context contexto, Uri imagen) {
        ...
        StorageReference archivoPath= FirebaseStorage.getInstance().getReference()
                .child(ConstantesFirebase.USUARIO_ALMACENAMIENTO_IMG_PERFIL).child(firebaseUser.getUid()+".jpg");

        archivoPath.putFile(imagen)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(contexto, "Error al intentar subir imagen", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public static void eliminarFotoPerfil(Context contexto, String imgUrl) {
